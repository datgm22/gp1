...
- 12 オブジェクト指向の特徴。カプセル化と継承
- 13 制作演習：ポリモーフィズム / Rigidbodyに頼らないこだわりのキャラクターの動かし方 / スキルアップのためのWebサービスの利用
...
- Re:verser プレイヤーとカメラスクロールの連携を考える
  - オブジェクト指向基礎
  - プレイヤーと画面切り替えの制御システムを設計する
    - googleにログイン
    - Googleドライブを開く
    - 新規 > Googleスプレッドシートを開く
    - スプレッドシート名を「画面切り替え：氏名」
...
### 内容
- Unityプロジェクトの提出(更新がなければ不要)
  - デスクトップに前回コピーしたフォルダーや圧縮ファイルが残っていたら削除
...
- 正月課題の仕上げと発表
  - 1週間ゲームジャムに公開できていたらURLを[こちら](https://docs.google.com/forms/d/e/1FAIpQLSdPXGSQ3ueVghzfhK7DAGMT4nFAj9RK3wM842cuz9i_LPFzUA/viewform?usp=sf_link)に報告
